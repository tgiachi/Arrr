...
public static class JsonUtils
{
    ...
    public static T DeserializeFromFile<T>(string filePath, JsonSerializerContext context)
    {
        ...
        {
            var json = File.ReadAllText(normalizedPath);
            var options = CreateJsonSerializerOptions(context);
            var result = JsonSerializer.Deserialize(json, options.GetTypeInfo(typeof(T)));
    ...
    private static JsonSerializerOptions CreateJsonSerializerOptions(JsonSerializerContext context)
        => new(GetJsonSerializerOptions())
        {
