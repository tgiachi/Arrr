...
public class NtfySinkPluginTests
{
    ...
    public void SetUp()
    {
        ...
        _sink = new NtfySinkPlugin(_handler);
    }
    ...
    {
        var ctx = new FakeSinkContext(configFactory: _ => new NtfySinkConfig
        {
        ...
        var notification = new Notification(Guid.NewGuid(), "rss", "New Article", "Article body", DateTimeOffset.UtcNow, null);
