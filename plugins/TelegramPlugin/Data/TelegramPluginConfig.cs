...
public class TelegramPluginConfig
{
    ...
    [Sensitive]
    [Description("App hash from my.telegram.org (stored encrypted)")]
    ...
    [Sensitive]
    [Description("Telegram 2FA password, if enabled on your account (stored encrypted). Leave empty if not set.")]
